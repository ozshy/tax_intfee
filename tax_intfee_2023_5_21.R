...
ggplot(phi_bar.df, aes(x=delta1.vec)) + geom_line(aes(y=phi_bar_delta1_tau0.vec), linetype = "solid", size=1.2) + geom_line(aes(y=phi_bar_delta1_tau02.vec), linetype = "solid", size=1.2) + geom_line(aes(y=phi_bar_x_one_minus_delta1_tau0.vec), linetype = "dotdash", size=1.2, color="red") + geom_line(aes(y=phi_bar_x_one_minus_delta1_tau02.vec), linetype = "dotdash", size=1.2, color="red") + labs(x= TeX("Merchants' rate of tax deduction $\\delta$"), y= TeX("Interchange fee $\\bar{f}$ and effective merchant fee burden  $(1-\\delta)\\cdot\\bar{f}$")) + theme(axis.text.x = element_text(size = 20, color = "black"),  axis.text.y = element_text(size = 20, color = "black"), text = element_text(size = 20), axis.title.x = element_text(size = 24), axis.title.y = element_text(size = 24))+ scale_x_continuous(breaks = seq(0,0.5,0.05)) + scale_y_continuous(breaks = seq(-0.1,0.5,0.05)) + annotate("text", x = 0.43, y = 0.45, label =TeX("$\\bar{f_0}= \\bar{f}(\\delta , \\tau_0)$"), size = 10) + annotate("text", x = 0.35, y = 0.35, label =TeX("$\\bar{f_1} = \\bar{f}(\\delta , \\tau_1)$"), size = 10) + annotate("text", x = 0.35, y = 0.06, label =TeX("$(1-\\delta)\\cdot\\bar{f_1}$"), size = 10, color="red") + geom_segment(aes(x = 0.39, y = 0.35, xend = 0.48, yend = 0.35), arrow = arrow(length = unit(0.5, "cm")), size=1) + annotate("text", x = 0.195, y = 0.06, label =TeX("$(1-\\delta)\\cdot \\bar{f_0}$"), size = 10, color="red") 
...
ggplot(xy_star.df, aes(x=regulated_IF)) + geom_line(aes(y=xhat), size=1.2) + geom_line(aes(y=yhat), size=1.2) + geom_line(aes(y=xstar.vec), size=1.2, linetype="dotted", color="red") + geom_line(aes(y=ystar.vec), size=1.2, linetype="dotted", color="red")  + theme(axis.text.x = element_text(size = 20, color = "black"), axis.text.y = element_text(size = 20, color = "black"), text = element_text(size = 20), axis.title.x = element_text(size = 24), axis.title.y = element_text(size = 24)) + labs(x= TeX("Regulated (fixed) interchange fee $f_R$"), y= TeX("Comparing $\\hat{x}$ and $\\hat{y}$ with optimal $x^*$ and optimal $y^*$")) + scale_x_continuous(breaks = seq(-1,1,0.25)) + scale_y_continuous(breaks = seq(0,4.3,0.5)) + annotate("text", x = -0.65, y = 0.46, label =TeX("$x^* = y^* = 1/3$"), size = 10, color="red") + annotate("text", x = -0.7, y = 1.15, label =TeX("$\\hat{x}(f_R)$"), size = 10)  + annotate("text", x = 0.75, y = 1.15, label =TeX("$\\hat{y}(f_R)$"), size = 10) + geom_line(aes(y=wstar.vec), size=1.2, linetype="dotted", color="red") + geom_line(aes(y=w), size=1.2) + annotate("text", x = -0.75, y = 4.1, label =TeX("$W^*"), size = 10, color="red")  + geom_line(aes(y=w), size=1.2) + annotate("text", x = 0.75, y = 3.67, label =TeX("$\\hat{W}(f_R)"), size = 10)
...
ggplot(w_max.df, aes(x=delta.vec)) + geom_line(aes(y=tau_max.vec), size=1.2, color="blue") +geom_line(aes(y=xbar_max.vec), size=1.2, linetype="longdash") + geom_line(aes(y=ybar_max.vec), linetype="longdash", size=1.2) + geom_line(aes(y=xstar_max.vec), size=1.2, linetype="dotted")+ geom_line(aes(y=ystar_max.vec), size=1.2, linetype="dotted") + geom_line(aes(y=phi_bar_max.vec), size=1.2, linetype="dotdash", color="red")+ labs(x= TeX("Assumed merchants' tax deduction rate $\\delta$"), y= TeX("Welfare-maximizing card reward tax rate $\\tau$")) + theme(axis.text.x = element_text(size = 20, color = "black"), axis.text.y = element_text(size = 20, color = "black"), text = element_text(size = 20), axis.title.x = element_text(size = 24), axis.title.y = element_text(size = 24))+ scale_x_continuous(breaks = seq(0,0.5,0.05)) + scale_y_continuous(breaks = seq(0, 0.65, 0.05)) + annotate("text", x = 0.2, y = 0.565, label =TeX("$\\hat{x}(\\delta, \\tau)$"), size = 10) + annotate("text", x = 0.2, y = 0.31, label =TeX("$\\bar{f}(\\delta, \\tau)$"), size = 10, color="red")+ annotate("text", x = 0.2, y = 0.67, label =TeX("$\\hat{y}(\\delta, \\tau)$"), size = 10) + annotate("text", x = 0.2, y = 0.47, label =TeX("$x^* = y^*$"), size = 10) + annotate("text", x = 0.2, y = 0.05, label =TeX("$\\tau(\\delta)$"), size = 10, color="blue")                                                                          
...
ggplot(w_max.df, aes(x=delta.vec)) + geom_line(aes(y=tau_max.vec), size=1.2, color="blue") +geom_line(aes(y=xbar_max.vec), size=1.2, linetype="longdash") + geom_line(aes(y=ybar_max.vec), linetype="longdash", size=1.2) + geom_line(aes(y=xstar_max.vec), size=1.2, linetype="dotted")+ geom_line(aes(y=ystar_max.vec), size=1.2, linetype="dotted") + geom_line(aes(y=phi_bar_max.vec), size=1.2, linetype="dotdash", color="red")+ labs(x= TeX("Assumed merchants' tax deduction rate $\\delta$"), y= TeX("Welfare-maximizing card reward tax rate $\\tau$")) + theme(axis.text.x = element_text(size = 20, color = "black"), axis.text.y = element_text(size = 20, color = "black"), text = element_text(size = 20), axis.title.x = element_text(size = 24), axis.title.y = element_text(size = 24))+ scale_x_continuous(breaks = seq(0,0.5,0.05)) + scale_y_continuous(breaks = seq(-0.25, 0.75, 0.05)) + annotate("text", x = 0.2, y = 0.55, label =TeX("$\\hat{x}(\\delta, \\tau)$"), size = 10) + annotate("text", x = 0.2, y = -0.14, label =TeX("$\\bar{f}(\\delta, \\tau)$"), size = 10, color="red")+ annotate("text", x = 0.2, y = 0.73, label =TeX("$\\hat{y}(\\delta, \\tau)$"), size = 10) + annotate("text", x = 0.2, y = 0.46, label =TeX("$x^* = y^*$"), size = 10) + annotate("text", x = 0.2, y = 0.05, label =TeX("$\\tau(\\delta)$"), size = 10, color="blue")                                                                                            
